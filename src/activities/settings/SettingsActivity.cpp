...
void SettingsActivity::render(RenderLock&&) {
  ...
  // Draw FlexBLE + upstream CrossInk version labels at the bottom of the
  // System tab. FlexBLE's own semver is the primary identity; CrossInk's
  // version reads as the upstream sync point in smaller secondary text.
  if (selectedCategoryIndex == 3) {
    static constexpr const char* versionLabel = "FlexBLE " FLEXBLE_VERSION " (CrossInk " CROSSINK_VERSION ")";
