...
void HomeActivity::preRenderCarouselFrames() {
  ...
  // direction is always a cache hit. The e-ink display is refreshing from
  // the previous activity while this runs, so the extra two renders are free
